...
public class AspectAop {
    ...
    //    @Before("within(example..*)")
    @Before("execution(* example.PaymentImplementClass.makePayment(..))") //pointcut is within parenthesis
...
//     It can also control the flow of execution by deciding whether to proceed with the execution of the join point or not.
    @Around("execution(* example.PaymentImplementClass.makePayment(..))")
